									...
									<div class="col-xs-6 col-sm-3 pricing-box">
										<div class="widget-box">
											<div class="widget-header header-color-dark">
												<h5 class="bigger lighter">Jenkins</h5>
											</div>
												...
												<div class="widget-main">
													<ul class="list-unstyled spaced2">
														<li>
															...
															Restart For (MBG,EBG,PCG,ELOIS)(QAS,TST,PRE,CONS,DEV,SANBOX) Windchill
														</li>

														<li>
															<i class="icon-ok green"></i>
															Upload For (MBG,EBG,PCG,ELOIS,ALM)(QAS,TST,PRE,DEV) Windchill and Integrity
														</li>

														<li>
															<i class="icon-ok green"></i>
															Stop For (MBG,EBG,PCG,ELOIS)(QAS,TST,PRE,CONS,DEV,SANBOX) Windchill
														</li>

														<li>
															<i class="icon-ok green"></i>
															Start For (MBG,EBG,PCG,ELOIS)(QAS,TST,PRE,CONS,DEV,SANBOX) Windchill
														</li>
									...
									<div class="col-xs-6 col-sm-3 pricing-box">
										<div class="widget-box">
											<div class="widget-header header-color-orange">
												<h5 class="bigger lighter">Planning Management Center</h5>
											</div>
											...
											<div class="widget-body">
												<div class="widget-main">
													<ul class="list-unstyled spaced2">
														<li>
															<i class="icon-ok green"></i>
															Start For ABPP and WebLogic
														</li>

														<li>
															<i class="icon-ok green"></i>
															Stop For ABPP and WebLogic
														</li>
